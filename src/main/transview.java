...
public class transview implements Initializable {
    @FXML
    ...
    private ObservableList<transview.ShowData> data;
    Connection conn ;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
     ...
     if(genralledger.search == "CURRENT MONTH"){
         Platform.runLater(new Runnable() {
             @Override
             public void run() {
                 try {
                     ...
                     statement1.execute("SELECT * FROM journal  WHERE  post ='yes' AND parent_id='"+genralledger.aid+"' AND MONTH(dt) = MONTH(CURRENT_DATE()) ");
                     ...
                     while (results.next()) {
                         ...
                         data.add(new transview.ShowData(results.getString("num"), accountname, parentaccountname, costcenter, results.getString("debit"),results.getString("credit"), results.getString("dt"),results.getString("user"),results.getString("id")));
                     }
     ...
     }else if(genralledger.search == "CURRENT QUARTER"){
         Platform.runLater(new Runnable() {
             @Override
             public void run() {
                 try {
                     conn = DriverManager.getConnection("jdbc:mysql://" + Main.ip + "/fouadcompany", "root", "");
                     statement1 = conn.createStatement();
                     statement1.execute("SELECT * FROM journal  WHERE  post ='yes' AND parent_id='"+genralledger.aid+"' AND QUARTER(dt) = QUARTER(curdate()) ");
                     ResultSet results = statement1.getResultSet();
                     data = FXCollections.observableArrayList();
                     while (results.next()) {
                         statement2 = conn.createStatement();
     ...
     }else if(genralledger.search == "CURRENT YEAR"){
         Platform.runLater(new Runnable() {
             @Override
             public void run() {
                 try {
                     conn = DriverManager.getConnection("jdbc:mysql://" + Main.ip + "/fouadcompany", "root", "");
                     statement1 = conn.createStatement();
                     statement1.execute("SELECT * FROM journal  WHERE  post ='yes' AND parent_id='"+genralledger.aid+"' AND YEAR(dt) = YEAR(CURRENT_DATE()) ");
                     ResultSet results = statement1.getResultSet();
                     data = FXCollections.observableArrayList();
                     while (results.next()) {
                         statement2 = conn.createStatement();
     ...
     }else if(genralledger.search == "LAST MONTH"){
         Platform.runLater(new Runnable() {
             @Override
             public void run() {
                 try {
                     conn = DriverManager.getConnection("jdbc:mysql://" + Main.ip + "/fouadcompany", "root", "");
                     statement1 = conn.createStatement();
                     statement1.execute("SELECT * FROM journal  WHERE  post ='yes' AND parent_id='"+genralledger.aid+"' AND MONTH(dt) = MONTH(CURRENT_DATE - INTERVAL 1 MONTH) ");
                     ResultSet results = statement1.getResultSet();
                     data = FXCollections.observableArrayList();
                     while (results.next()) {
                         statement2 = conn.createStatement();
     ...
     }else if(genralledger.search == "LAST QUARTER"){
         Platform.runLater(new Runnable() {
             @Override
             public void run() {
                 try {
                     conn = DriverManager.getConnection("jdbc:mysql://" + Main.ip + "/fouadcompany", "root", "");
                     statement1 = conn.createStatement();
                     statement1.execute("SELECT * FROM journal  WHERE  post ='yes' AND parent_id='"+genralledger.aid+"' AND QUARTER(dt) = QUARTER(curdate() - INTERVAL 1 quarter) ");
                     ResultSet results = statement1.getResultSet();
                     data = FXCollections.observableArrayList();
                     while (results.next()) {
                         statement2 = conn.createStatement();
     ...
     }else if(genralledger.search == "LAST YEAR"){
         Platform.runLater(new Runnable() {
             @Override
             public void run() {
                 try {
                     conn = DriverManager.getConnection("jdbc:mysql://" + Main.ip + "/fouadcompany", "root", "");
                     statement1 = conn.createStatement();
                     statement1.execute("SELECT * FROM journal  WHERE  post ='yes' AND parent_id='"+genralledger.aid+"' AND YEAR(dt) = YEAR(CURRENT_DATE - INTERVAL 1 YEAR) ");
                     ResultSet results = statement1.getResultSet();
                     data = FXCollections.observableArrayList();
                     while (results.next()) {
                         statement2 = conn.createStatement();
     ...
     }else if(genralledger.search == "SPECIFIC"){
         Platform.runLater(new Runnable() {
             @Override
             public void run() {
                 try {
                     conn = DriverManager.getConnection("jdbc:mysql://" + Main.ip + "/fouadcompany", "root", "");
                     statement1 = conn.createStatement();
                     statement1.execute("SELECT * FROM journal  WHERE  post ='yes' AND parent_id='"+genralledger.aid+"' AND dt between '"+genralledger.d1+"' AND '"+genralledger.d2+"' ");
                     ResultSet results = statement1.getResultSet();
                     data = FXCollections.observableArrayList();
                     while (results.next()) {
                         statement2 = conn.createStatement();

...
public class extractviewe implements Initializable {
    @FXML
    ...
    Object idp;
    Object ide;
    private ObservableList<extractviewe.ShowData> data;
    @Override
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ide=transdetails.eid;
        idp=transdetails.pid;
        try {
